...
func (c *Codec) NewRequest(w http.ResponseWriter, r *http.Request) rpc.CodecRequest {
	return newCodecRequest(w, r)
}
...
func newCodecRequest(w http.ResponseWriter, r *http.Request) rpc.CodecRequest {
	// Decode the request body and check if RPC method is valid.
	req := new(serverRequest)
	err := json.NewDecoder(r.Body).Decode(req)
	r.Body.Close()
	return &CodecRequest{request: req, response: w, err: err}
}
